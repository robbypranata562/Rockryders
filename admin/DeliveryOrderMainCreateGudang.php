...
<div class="content-wrapper">
    ...
    <section class="content">
        <form name="formDeliveryOrder" id="formDeliveryOrder" class="form-body" data-toggle="validator" action="ActSaveTransactionGudang.php" method="post" enctype="multipart/form-data">
            <div class="box">
                <div class="box-header with-border">
                    <h3 class="box-title">Transaksi Gudang</h3>
...
<script type="text/javascript">
    $( document ).ready(function() {
            ...
            $("#btnTambahBarang").click(function(e){
                ...
                $.ajax({
                    url: 'ActCheckStokByColorAndSizeGudang.php',
                    type: 'POST',
                    dataType: "json",
                    data:
                    {
